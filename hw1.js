...
const Student = class Student {
    ...
    {
        if (typeof firstName == 'string' && typeof lastName == 'string' && typeof gpa == 'number' && typeof degreeType == 'string')
        {
...
const Product = class Product {
   ...
   static inStock = (products) => products.filter(product => product.availability === "In Stock");
     ...
     * Reference: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array 
     */
    static halfOff = (products) => products.map(product => ({ ...product, price: product.price * 0.5 }));
    ...
    static printProducts = (products) => {
        products.forEach(product => {
            ...
            console.log(`Product: ${product.name}, Cost: ${formattedPrice}, Availability: ${availabilityText}`);
        });
    }
